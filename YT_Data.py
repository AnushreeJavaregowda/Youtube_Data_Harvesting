...
atlas_username = 'anushree'
atlas_password = 'anushree'
atlas_cluster = 'cluster0'
client = MongoClient(
    f"mongodb+srv://{atlas_username}:{atlas_password}@{atlas_cluster}.bfprvbv.mongodb.net/?retryWrites=true&w=majority")
# mongodb+srv://anushree:<password>@cluster0.bfprvbv.mongodb.net/?retryWrites=true&w=majority

db = client['youtube_data']
collection = db['channel_data']

# api_key
Api_key = 'AIzaSyDXpiRFGG1RHWpRue9y_4UPJ6TvCshxEpc'
...
with h:
    ...
    select_question = st.selectbox("select the question", query_options)
